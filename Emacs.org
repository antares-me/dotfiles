...
#+begin_src emacs-lisp
  ...
  (load-file "~/.emacs.d/lisp/antares-settings.el")

  ;; Load settings for the first time
  (antares/load-system-settings)

  (require 'subr-x)
  (setq antares/is-termux
        (string-suffix-p "Android" (string-trim (shell-command-to-string "uname -a"))))

  (setq antares/is-guix-system (and (eq system-type 'gnu/linux)
                               (require 'f)
...
#+begin_src emacs-lisp :tangle no
  ...
  (setq use-package-always-ensure (not antares/is-guix-system))
...
#+begin_src emacs-lisp
  ...
  (setq antares/exwm-enabled (and (not antares/is-termux)
                             (eq window-system 'x)
                             (seq-contains command-line-args "--use-exwm")))

  (when antares/exwm-enabled
    (require 'antares-desktop))
...
#+begin_src emacs-lisp
    ...
    (defun antares/dont-arrow-me-bro ()
      (interactive)
    ...
    (use-package evil
      ...
      :config
      (add-hook 'evil-mode-hook 'antares/evil-hook)
      (evil-mode 1)
      ...
      (unless antares/is-termux
        ;; Disable arrow keys in normal and visual modes
        (define-key evil-normal-state-map (kbd "<left>") 'antares/dont-arrow-me-bro)
        (define-key evil-normal-state-map (kbd "<right>") 'antares/dont-arrow-me-bro)
        (define-key evil-normal-state-map (kbd "<down>") 'antares/dont-arrow-me-bro)
        (define-key evil-normal-state-map (kbd "<up>") 'antares/dont-arrow-me-bro)
        (evil-global-set-key 'motion (kbd "<left>") 'antares/dont-arrow-me-bro)
        (evil-global-set-key 'motion (kbd "<right>") 'antares/dont-arrow-me-bro)
        (evil-global-set-key 'motion (kbd "<down>") 'antares/dont-arrow-me-bro)
        (evil-global-set-key 'motion (kbd "<up>") 'antares/dont-arrow-me-bro))
...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (general-create-definer antares/leader-key-def
      :keymaps '(normal insert visual emacs)
      :prefix "SPC"
      :global-prefix "C-SPC")

    (general-create-definer antares/ctrl-c-keys
      :prefix "C-c"))
...
#+begin_src emacs-lisp
  ...
  (pcase system-type
    ((or 'gnu/linux 'windows-nt 'cygwin)
     (set-face-attribute 'default nil
                         :font "JetBrains Mono"
                         :weight 'light
                         :height (antares/system-settings-get 'emacs/default-face-size)))
  ...
  (set-face-attribute 'fixed-pitch nil
                      :font "JetBrains Mono"
                      :weight 'light
                      :height (antares/system-settings-get 'emacs/fixed-face-size))

  ;; Set the variable pitch face
  (set-face-attribute 'variable-pitch nil
                      ;; :font "Cantarell"
                      :font "Iosevka Aile"
                      :height (antares/system-settings-get 'emacs/variable-face-size)
                      :weight 'light)
...
#+begin_src emacs-lisp
  ...
  (defun antares/replace-unicode-font-mapping (block-name old-font new-font)
  ...
  (use-package unicode-fonts
    ...
    (mapcar
      (lambda (block-name)
        (antares/replace-unicode-font-mapping block-name "Apple Color Emoji" "Noto Color Emoji"))
      '("Dingbats"
        "Emoticons"
...
(defun antares/show-server-edit-buffer (buffer)
  ;; TODO: Set a transient keymap to close with 'C-c C-c'
  (split-window-vertically -15)
  (other-window 1)
  (set-buffer buffer))

(setq server-window #'antares/show-server-edit-buffer)
...
#+begin_src emacs-lisp
  ...
  (defun antares/org-file-jump-to-heading (org-file heading-title)
    (interactive)
  ...
  (defun antares/org-file-show-headings (org-file)
    (interactive)
    (find-file (expand-file-name org-file))
    (counsel-org-goto)
    (org-overview)
...
#+begin_src emacs-lisp
  ...
  (antares/leader-key-def
    ...
    "fdE" '((lambda () (interactive) (antares/org-file-show-headings "~/.dotfiles/Emacs.org")) :which-key "edit config")
    ...
    "fds" '((lambda () (interactive) (antares/org-file-jump-to-heading "~/.dotfiles/Systems.org" "Base Configuration")) :which-key "base system")
    "fdS" '((lambda () (interactive) (antares/org-file-jump-to-heading "~/.dotfiles/Systems.org" system-name)) :which-key "this system")
    "fdp" '((lambda () (interactive) (antares/org-file-jump-to-heading "~/.dotfiles/Desktop.org" "Panel via Polybar")) :which-key "polybar")
...
#+begin_src emacs-lisp
  ...
  (defun antares/get-project-root ()
  ...
  (use-package consult
    ...
    :custom
    (consult-project-root-function #'antares/get-project-root)
...
#+begin_src emacs-lisp
  ...
  ;; (defun antares/center-buffer-with-margins ()
  ;;   (let ((margin-size (/ (- (frame-width) 80) 3)))
  ;;     (set-window-margins nil margin-size margin-size)))

  (defun antares/org-mode-visual-fill ()
  ...
  (use-package visual-fill-column
    :defer t
    :hook (org-mode . antares/org-mode-visual-fill))
...
#+begin_src emacs-lisp
  ...
  ;;   "dh"  `(,(antares/dired-link "~") :which-key "Home")
  ;;   "dn"  `(,(antares/dired-link "~/Notes") :which-key "Notes")
  ;;   "do"  `(,(antares/dired-link "~/Downloads") :which-key "Downloads")
  ;;   "dp"  `(,(antares/dired-link "~/Pictures") :which-key "Pictures")
  ;;   "dv"  `(,(antares/dired-link "~/Videos") :which-key "Videos")
  ;;   "d."  `(,(antares/dired-link "~/.dotfiles") :which-key "dotfiles")
  ;;   "de"  `(,(antares/dired-link "~/.emacs.d") :which-key ".emacs.d"))
...
#+begin_src emacs-lisp
  ...
  (when antares/is-guix-system
    (straight-use-package '(org :type built-in)))

  (use-package org
    :defer t
    :hook (org-mode . antares/org-mode-setup)
    :config
    (setq org-ellipsis " ▾"
...
#+begin_src emacs-lisp
  ...
  (defun antares/org-babel-tangle-dont-ask ()
    ;; Dynamic scoping to the rescue
    (let ((org-confirm-babel-evaluate nil))
      (org-babel-tangle)))

  (add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook #'antares/org-babel-tangle-dont-ask
...
#+begin_src emacs-lisp
  ...
  (defun antares/search-org-files ()
    (interactive)
...
#+begin_src emacs-lisp
  ...
  (antares/leader-key-def
    ...
    "os"  '(antares/counsel-rg-org-files :which-key "search notes")
...
#+begin_src emacs-lisp
  ...
  ;;         org-gcal-file-alist `(("daviwil@github.com" . ,(antares/org-path "Calendar.org"))
  ;;                               (,(password-store-get "Misc/Calendars/GitHub/AtomTeam") . ,(antares/org-path "Calendar.org"))
  ;;                              )))
...
#+begin_src emacs-lisp
  ...
  (defun antares/org-present-prepare-slide ()
    (org-overview)
    (org-show-entry)
    (org-show-children))

  (defun antares/org-present-hook ()
    ...
    (antares/org-present-prepare-slide))

  (defun antares/org-present-quit-hook ()
    (setq-local face-remapping-alist '((default variable-pitch default)))
    (setq header-line-format nil)
    (org-present-small)
    (org-remove-inline-images))

  (defun antares/org-present-prev ()
    (interactive)
    (org-present-prev)
    (antares/org-present-prepare-slide))

  (defun antares/org-present-next ()
    (interactive)
    (org-present-next)
    (antares/org-present-prepare-slide))
  ...
  (use-package org-present
    :bind (:map org-present-mode-keymap
           ("C-c C-j" . antares/org-present-next)
           ("C-c C-k" . antares/org-present-prev))
    :hook ((org-present-mode . antares/org-present-hook)
           (org-present-mode-quit . antares/org-present-quit-hook)))
...
#+begin_src emacs-lisp
  ...
  (defun antares/org-start-presentation ()
    (interactive)
    (org-tree-slide-mode 1)
    (setq text-scale-mode-amount 3)
    (text-scale-mode 1))

  (defun antares/org-end-presentation ()
    (interactive)
    (text-scale-mode 0)
  ...
  (use-package org-tree-slide
    ...
    (evil-define-key 'normal org-tree-slide-mode-map
      (kbd "q") 'antares/org-end-presentation
...
I generate and publish my personal site [[https://daviwil.com/][daviwil.com]] using =org-mode= using =antares/generate-site= and =antares/publish-site=:

#+begin_src emacs-lisp

  (defun antares/generate-site ()
    (interactive)
    (start-process-shell-command "emacs" nil "emacs --batch -l ~/Projects/Writing/Blog/publish.el --funcall antares/publish"))
...
#+begin_src emacs-lisp
  ...
  (defun antares/switch-project-action ()
  ...
  (use-package projectile
    ...
    (setq projectile-switch-project-action #'antares/switch-project-action))
...
#+begin_src emacs-lisp
  ...
  (defun antares/set-js-indentation ()
  ...
  (use-package js2-mode
    ...
    (add-hook 'js2-mode-hook #'antares/set-js-indentation)
    (add-hook 'json-mode-hook #'antares/set-js-indentation))
...
#+begin_src emacs-lisp
  ...
  (use-package markdown-mode
    ...
    (defun antares/set-markdown-header-font-sizes ()
    ...
    (defun antares/markdown-mode-hook ()
      (antares/set-markdown-header-font-sizes))

    (add-hook 'markdown-mode-hook 'antares/markdown-mode-hook))
...
#+begin_src emacs-lisp
  ...
  (defun antares/debbugs-guix-patches ()
    (interactive)
...
#+begin_src emacs-lisp
  ...
  (defun antares/enter-focus-mode ()
    (interactive)
    (darkroom-mode 1)
    (display-line-numbers-mode 0))

  (defun antares/leave-focus-mode ()
    (interactive)
    (darkroom-mode 0)
    (display-line-numbers-mode 1))

  (defun antares/toggle-focus-mode ()
    (interactive)
    (if (symbol-value darkroom-mode)
      (antares/leave-focus-mode)
      (antares/enter-focus-mode)))

  (antares/leader-key-def
    "tf" '(antares/toggle-focus-mode :which-key "focus mode"))
...
#+begin_src emacs-lisp
  ...
  (setq antares/command-window-frame nil)

  (defun antares/toggle-command-window ()
    (interactive)
    (if antares/command-window-frame
        (progn
        ...
        (progn
          ...
          (with-current-buffer
            ...
            (text-scale-set -1))
          (setq antares/command-window-frame
            (posframe-show
  ...
  (antares/leader-key-def
   "tc" 'antares/toggle-command-window)
...
#+begin_src emacs-lisp
  ...
  (use-package obs-websocket
    ...
    :config
    (defhydra antares/stream-keys (:exit t)
      "Stream Commands"
    ...
    (global-set-key (kbd "s-s") #'antares/stream-keys/body))
...
#+begin_src emacs-lisp
  ...
  (setq antares/mail-enabled (member system-name '("zerocool" "acidburn")))
  (setq antares/mu4e-inbox-query nil)
  (when antares/mail-enabled
    (require 'antares-mail))
...
#+begin_src emacs-lisp
  ...
  (defun antares/get-current-package-version ()
    (interactive)
  ...
  (defun antares/map-line-to-status-char (line)
    (cond ((string-match "^?\\? " line) "?")))

  (defun antares/get-git-status-prompt ()
    (let ((status-lines (cdr (process-lines "git" "status" "--porcelain" "-b"))))
      (seq-uniq (seq-filter 'identity (mapcar 'antares/map-line-to-status-char status-lines)))))

  (defun antares/get-prompt-path ()
  ...
  (defun antares/eshell-prompt ()
    (let ((current-branch (magit-get-current-branch))
          (package-version (antares/get-current-package-version)))
      (concat
       "\n"
       (propertize (system-name) 'face `(:foreground "#62aeed"))
       (propertize " ॐ " 'face `(:foreground "white"))
       (propertize (antares/get-prompt-path) 'face `(:foreground "#82cfd3"))
       (when current-branch
         (concat
    ...
    (add-hook 'eshell-banner-load-hook
              '(lambda ()
                 (setq eshell-banner-message
                       (concat "\n" (propertize " " 'display (create-image "~/.dotfiles/emacs/.emacs.d/images/flux_banner.png" 'png nil :scale 0.2 :align-to "center")) "\n\n")))))

  (defun antares/eshell-configure ()
    ...
    (setq eshell-prompt-function      'antares/eshell-prompt
  ...
  (use-package eshell
    :hook (eshell-first-time-mode . antares/eshell-configure)
    :init
...
#+begin_src emacs-lisp
  ...
  (defun antares/around-tracking-add-buffer (original-func buffer &optional faces)
    (let* ((name (buffer-name buffer))
      ...
      (antares/update-polybar-telegram)
      result))

  (defun antares/after-tracking-remove-buffer (buffer)
    (antares/update-polybar-telegram))

  (advice-add 'tracking-add-buffer :around #'antares/around-tracking-add-buffer)
  (advice-add 'tracking-remove-buffer :after #'antares/after-tracking-remove-buffer)
  (advice-remove 'tracking-remove-buffer #'antares/around-tracking-remove-buffer)
  ...
  (defun antares/before-exwm-workspace-switch (frame-or-index &optional force)
    (when (fboundp 'tracking-remove-visible-buffers)
      (when (eq exwm-workspace-current-index 0)
        (tracking-remove-visible-buffers))))

  (advice-add 'exwm-workspace-switch :before #'antares/before-exwm-workspace-switch)
...
#+begin_src emacs-lisp
  ...
  (defun antares/on-erc-track-list-changed ()
  ...
  (use-package erc
    :commands erc
    :hook (erc-track-list-changed . antares/on-erc-track-list-changed)
    :config
    (setq
        erc-nick "daviwil"
...
#+begin_src scheme :tangle guix/.config/guix/manifests/emacs.scm :noweb yes
